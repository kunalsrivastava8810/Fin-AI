...
import { API_URL, getUserTransactions } from "../utils/api";
...
const FinanceDashboard = () => {
    ...
    const handleSmartSavingPlan = () => {
        fetchData(`${API_URL}/savings/smart-plan`, { monthly_income: salary });
    };

    const handleInvestmentOpportunity = () => {
        fetchData(`${API_URL}/investment/opportunities`, { emergency_fund: fund });
    };

    const handleRiskManagement = () => {
        fetchData(`${API_URL}/risk/management-plan`, { monthly_income: salary });
    };
