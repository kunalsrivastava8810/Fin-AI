...
import { addUserTransaction, getUserTransactions } from "../utils/api";
...
function DashboardPage({ onNavigate }) {
  ...
  const getTransactions = async () => {
    try {
      ...
      setTransactions(data); // Update state with the transactions
    } catch (error) {
  ...
  const addTransaction = async (e) => {
    ...
    try {
      const data = await addUserTransaction(userId, {
        name: formData.name,
        ...
        <div className="">
          <div className="flex gap-7 py-4 w-11/12 ml-4">
            ...
            <button
              ...
              className="flex-1 text-left bg-white p-6 rounded-3xl shadow-sm border cursor-pointer hover:bg-gray-100 border-gray-100 hover:shadow-md transition-shadow duration-200"
            >
            ...
            <button
              type="button"
              onClick={() => onNavigate?.("goal-tracking")}
              className="flex-1 text-left bg-white p-6 rounded-3xl shadow-sm border cursor-pointer hover:bg-gray-100 border-gray-100 hover:shadow-md transition-shadow duration-200"
            >
